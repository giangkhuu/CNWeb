        ...
        <table class="table table-bordered table-hover table-sm mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="{{ route('admin.loaisanpham.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn muốn xóa loại sản phẩm: {{ $value->tenloai }} không?')"><i class="bi bi-trash text-danger"></i></a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
